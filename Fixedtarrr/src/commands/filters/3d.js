...
module.exports = {
    name: '3d',
    aliases: ['rotation'],
    description: 'Apply 3D rotation audio effect',
    usage: '!3d',
    category: 'Filters',
    ...
    async execute(message, args, client) {
        ...
        await player.filters.setRotation(0.2);

        message.reply(embedBuilder.successEmbed('3D Audio Effect', 'Turned on: 3D Audio Effect'));
    }
};
