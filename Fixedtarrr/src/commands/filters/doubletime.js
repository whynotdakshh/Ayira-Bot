...
module.exports = {
    name: 'doubletime',
    aliases: ['dt', 'fast'],
    description: 'Apply double time effect (sped up)',
    usage: '!doubletime',
    category: 'Filters',
    ...
    async execute(message, args, client) {
        ...
        await player.filters.setTimescale({ speed: 1.5, pitch: 1.0, rate: 1.5 });

        message.reply(embedBuilder.successEmbed('Double Time Effect', 'Turned on: Double Time'));
    }
};
