...
module.exports = {
    name: 'vibrato',
    aliases: ['vib'],
    description: 'Apply vibrato effect (pitch oscillation)',
    usage: '!vibrato',
    category: 'Filters',
    ...
    async execute(message, args, client) {
        ...
        await player.filters.setVibrato(4.0, 0.75);

        message.reply(embedBuilder.successEmbed('Vibrato Effect', 'Turned on: Vibrato'));
    }
};
